...
.dividros-navbar-light .navbar-brand {
    color: #000;
}

.dividros-navbar-light .navbar-brand:hover {
    color: #000;
}
...
@media (max-width: 991.98px) {
    .dividros-navbar-light .navbar-nav {
        padding-bottom: 10px;
    }
}

.dividros-navbar-light .navbar-nav>.nav-item>.nav-link {
    font-size: 13px;
    padding-top: .9rem;
    padding-bottom: .9rem;
    padding-left: 20px;
...
.dividros-navbar-light .navbar-nav>.nav-item>.nav-link:hover {
    color: #6927ff;
}
...
.dividros-navbar-light .navbar-nav>.nav-item .dropdown-menu {
    border: none;
    background: #fff;
...
.dividros-navbar-light .navbar-nav>.nav-item.dividros-seperator {
    position: relative;
    margin-left: 20px;
    padding-left: 20px;
}
...
.dividros-navbar-light .navbar-nav>.nav-item.dividros-seperator:before {
    position: absolute;
    content: "";
    top: 10px;
    bottom: 10px;
...
.dividros-navbar-light .navbar-nav>.nav-item.cta>a {
    color: #fff;
...
.dividros-navbar-light .navbar-nav>.nav-item.cta>a span {
    display: inline-block;
    color: #fff;
}

.dividros-navbar-light .navbar-nav>.nav-item.cta>a:hover {
    color: #fff;
    background: #6927ff;
    border: 1px solid #6927ff;
}

.dividros-navbar-light .navbar-nav>.nav-item.cta.cta-colored a {
    border: 1px solid #38d39f;
    background: #38d39f !important;
}

.dividros-navbar-light .navbar-nav>.nav-item.active>a {
    color: rgba(255, 255, 255, 0.5);
    color: #6927ff;
}

.dividros-navbar-light .navbar-toggler {
    border: none;
    color: rgba(255, 255, 255, 0.5) !important;
    cursor: pointer;
    padding-right: 0;
...
.dividros-navbar-light .navbar-toggler:hover,
.dividros-navbar-light .navbar-toggler:focus {
    text-decoration: none;
    color: #6927ff;
    outline: none !important;
}

.dividros-navbar-light.scrolled {
    position: fixed;
    right: 0;
    left: 0;
    top: 0;
...
@media (max-width: 991.98px) {
    .dividros-navbar-light.scrolled .nav-item>.nav-link {
        padding-left: 0 !important;
        padding-right: 0 !important;
        padding-bottom: 0 !important;
    }
...
.dividros-navbar-light.scrolled .nav-item.active>a {
    color: #6927ff !important;
}

.dividros-navbar-light.scrolled .nav-item.cta>a {
    color: #fff !important;
    background: #6927ff;
...
.dividros-navbar-light.scrolled .nav-item.cta>a span {
    display: inline-block;
    color: #fff !important;
}

.dividros-navbar-light.scrolled .nav-item.cta.cta-colored span {
    border-color: #6927ff;
}

@media (max-width: 991.98px) {
    .dividros-navbar-light.scrolled .navbar-nav {
        background: none;
        border-radius: 0px;
...
.dividros-navbar-light.scrolled .navbar-toggler {
    border: none;
    color: rgba(0, 0, 0, 0.5) !important;
...
.dividros-navbar-light.scrolled .nav-link {
    padding-top: 0.9rem !important;
    padding-bottom: 0.9rem !important;
    color: #000 !important;
}

.dividros-navbar-light.scrolled .nav-link.active {
    color: #6927ff !important;
}

.dividros-navbar-light.scrolled.awake {
    margin-top: 0px;
...
.dividros-navbar-light.scrolled.sleep {
    -webkit-transition: .3s all ease-out;
    -o-transition: .3s all ease-out;
    transition: .3s all ease-out;
}

.dividros-navbar-light.scrolled .navbar-brand {
    color: #000;
}
...
.dividros-wrap-2 .domain-price span small {
    color: #000;
}
...
.servicos .media-body h3 {
    font-size: 20px;
    font-weight: 700;
}

.servicos .media-body.media-body-2 {
    width: 100% !important;
}
...
.servicos:hover .icon span {
    /*color: #6927ff;*/
    color: #152638;
}

.servicos:hover .media-body h3 {
    color: #fff;
}

.servicos:hover .media-body p {
...
.dividros-section-parallax {
    position: relative;
}

.dividros-section-parallax .parallax-img {
    background-size: cover;
    background-repeat: no-repeat;
...
.dividros-section-parallax .heading-section-white h2 {
    font-weight: 400 !important;
}
...
.block-3 .image:after {
    ...
    bottom: 0;
    content: '';
    -webkit-box-shadow: 20px 20px 0 0 #c2a7ff;
    box-shadow: 20px 20px 0 0 #c2a7ff;
}
...
.dividros-footer .dividros-footer-logo {
    text-transform: uppercase;
    letter-spacing: .1em;
}

.dividros-footer .dividros-footer-widget.bg-primary {
...
.dividros-footer .dividros-footer-widget h2 {
    font-weight: normal;
    color: #fff;
    margin-bottom: 40px;
    font-size: 20px;
...
.dividros-footer .dividros-footer-widget ul li a span {
...
.dividros-footer .dividros-footer-widget ul li a span:hover {
    color: #fff;
}

.dividros-footer .dividros-footer-widget .btn-primary {
    border: 1px solid transparent;
}

.dividros-footer .dividros-footer-widget .btn-primary:hover {
    background: #fff;
...
.dividros-footer a:hover {
    color: #fff;
}

.dividros-footer .dividros-heading-2 {
    font-size: 17px;
    font-weight: 400;
    color: #000;
}

.dividros-footer .price .subheading {
    color: rgba(255, 255, 255, 0.8);
}

.dividros-footer .price h3 {
    font-size: 40px;
    color: #fff;
    font-weight: 700;
}

.dividros-footer .price h3 span {
    font-size: 14px;
    font-weight: 400;
}

.dividros-footer-social li {
    list-style: none;
    margin: 0 10px 0 0;
    display: inline-block;
}

.dividros-footer-social li a {
    height: 50px;
    width: 50px;
    display: block;
    float: left;
...
.dividros-footer-social li a span {
    position: absolute;
    font-size: 26px;
    top: 50%;
    left: 50%;
...
.dividros-footer-social li a:hover {
    color: #fff;
}
...
.dividros-media .heading {
    font-weight: normal;
}

.dividros-media.dividros-media-shadow {
    padding: 40px;
    background: #fff;
...
.dividros-media.dividros-media-shadow:hover,
.dividros-media.dividros-media-shadow:focus {
    top: -3px;
...
.dividros-media.text-center .dividros-icon {
    margin: 0 auto;
}

.dividros-overflow-hidden {
    overflow: hidden;
}
...
.dividros-section .nav-pills p {
    margin-bottom: 0;
}

.dividros-section .nav-pills .nav-link {
    border-radius: 0;
    margin-bottom: 0;
    color: #666666;
    font-size: 18px;
...
.dividros-section .nav-pills .nav-link.active,
.dividros-section .nav-pills .nav-link:hover {
    color: #fff;
    -moz-transition: all 0.3s ease;
    -o-transition: all 0.3s ease;
    -webkit-transition: all 0.3s ease;
...
.dividros-section .nav-pills .nav-link.active:after,
.dividros-section .nav-pills .nav-link:hover:after {
    opacity: 1;
}
...
.dividros-section .tab-content .tab-pane h2 {
    font-size: 24px;
    font-weight: 700;
}

.dividros-section .tab-content .tab-pane .one-forth {
    width: 50%;
}

@media (max-width: 767.98px) {
    .dividros-section .tab-content .tab-pane .one-forth img {
        margin-bottom: 20px;
    }
}
...
.dividros-section .tab-content .tab-pane .one-half {
    width: 50%;
}
...
.dividros-parceiros {
    padding: 3em 0;
    /*background: #6927ff;
    background-image: linear-gradient(to left top, #a8abcb, #adb2cf, #b2b9d3, #b8c0d7, #bec7db, #c4ccde, #cbd1e2, #d1d6e5, #d8dbe8, #dee0eb, #e5e6ef, #ebebf2);*/
    background: #ffffff;
}

.dividros-parceiros a {
    width: 100%;
    opacity: .6;
...
.dividros-counter .text strong.number {
    font-weight: 700;
    font-size: 40px;
    color: #fff;
}

.dividros-counter .text span {
    font-size: 16px;
    color: rgba(255, 255, 255, 0.7);
}

@media (max-width: 767.98px) {
    .dividros-counter .counter-wrap {
        margin-bottom: 20px;
    }
    .dividros-parceiros {
        margin-bottom: 20px;
...
.dividros-counter .dividros-number {
    display: block;
    font-size: 72px;
    font-weight: bold;
    color: #6927ff;
...
.dividros-counter .dividros-label {
    font-size: 12px;
    text-transform: uppercase;
    letter-spacing: .1em;
}
